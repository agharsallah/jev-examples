...
import type { Charge, Verdict } from "./api.js";
...
export function meter(name: string, value: number, detail: string, blue = false): string {
...
function charge(c: Charge, i: number): string {
